 ...
 * @author jvm
 */
public class EditCommentCommand implements ActionCommand {
    ...
    public EditCommentCommand() {
        ...
        try {
            ...
            Logger.getLogger(EditCommentCommand.class.getName()).log(Level.SEVERE, "Не удалось найти сессионый бин", ex);
        }
    }
